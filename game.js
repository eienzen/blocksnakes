document.addEventListener("DOMContentLoaded", () => {
    ...
    const contractABI = [
        ...
        "function claimAllRewards(uint256 totalReward, address player, address referrer) external",
        "function withdrawAllTokens() external payable",
        "function getInternalBalance(address player) external view returns (uint256)",
        "function getRewardHistory(address player) external view returns (tuple(uint256 amount, uint256 timestamp, string rewardType, address referee)[])",
        "function contractBalance() external view returns (uint256)",
        "function withdrawalFeeInBnb() external view returns (uint256)",
        "function playerHistory(address) external view returns (uint256 gamesPlayed, uint256 totalRewards, uint256 totalReferrals, uint256 referralRewards, bool hasClaimedWelcomeBonus, uint256 internalBalance)"
    ];
